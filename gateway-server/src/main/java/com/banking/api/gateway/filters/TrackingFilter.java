...
public class TrackingFilter implements GlobalFilter {
    ...
    public boolean isCorrelationPresent(HttpHeaders httpHeaders) {
        return (filterUtils.getCorrelationId(httpHeaders) != null) ? true : false;
    }
    ...
    private JSONObject decodeJWT(String JWTToken) {
        String[] splitStrings = JWTToken.split("\\.");
        String base64EncodedBody = splitStrings[1];
